                ...
                <div className="max-w-2xl mx-auto">
                        ...
                        {isEditing ? (
                            <div className="mb-4 flex justify-center">
                                <input
                                    ...
                                    className="bg-[#1E293B] border border-blue-600/50 rounded-lg px-4 py-2 text-white text-center focus:outline-none focus:border-blue-500"
                                    autoFocus
                                />
                            </div>
                        ) : (
                            ...
                            {isEditing ? (
                                ...
                                <>
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[#1E293B] hover:bg-[#2D3B54] text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
                                    >
                                        <Edit2 className="h-4 w-4" />
                                        Edit Profile
                                    </button>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8">
                        <div className="bg-[#0F1729] border border-[#1E293B] rounded-xl p-6 text-center">
                            <div className="text-3xl font-bold text-white mb-1">{progressStats?.level || 'A1'}</div>
                            <div className="text-sm text-slate-400">Current Level</div>
                        </div>
                        <div className="bg-[#0F1729] border border-[#1E293B] rounded-xl p-6 text-center">
                            <div className="text-3xl font-bold text-white mb-1">{progressStats?.speaking?.sessionsCompleted || 0}</div>
                            <div className="text-sm text-slate-400">Sessions</div>
                        </div>
                        <div className="bg-[#0F1729] border border-[#1E293B] rounded-xl p-6 text-center">
                            <div className="text-3xl font-bold text-white mb-1">{progressStats?.vocabulary?.itemsLearned || 0}</div>
